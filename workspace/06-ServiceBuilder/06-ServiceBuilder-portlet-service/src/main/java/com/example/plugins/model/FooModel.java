...
/**
 * The base model interface for the Foo service. Represents a row in the &quot;ServiceBuilder_Foo&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link com.example.plugins.model.impl.FooModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link com.example.plugins.model.impl.FooImpl}.
 * </p>
 *
...
public interface FooModel extends BaseModel<Foo>, StagedGroupedModel {
    ...
    @Override
    public int compareTo(com.example.plugins.model.Foo foo);

    @Override
    public int hashCode();

    @Override
    public CacheModel<com.example.plugins.model.Foo> toCacheModel();

    @Override
    public com.example.plugins.model.Foo toEscapedModel();

    @Override
    public com.example.plugins.model.Foo toUnescapedModel();
