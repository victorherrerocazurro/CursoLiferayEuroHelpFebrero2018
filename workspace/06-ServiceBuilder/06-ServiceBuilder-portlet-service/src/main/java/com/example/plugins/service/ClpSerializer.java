...
import com.example.plugins.model.FooClp;
...
public class ClpSerializer {
        ...
        synchronized (ClpSerializer.class) {
            ...
            try {
                ...
                String portletPropsServletContextName = (String) getMethod.invoke(null,
                        "06-ServiceBuilder-portlet-deployment-context");
            ...
            if (Validator.isNull(_servletContextName)) {
                _servletContextName = "06-ServiceBuilder-portlet";
            }
    ...
    public static Object translateOutput(BaseModel<?> oldModel) {
        ...
        if (oldModelClassName.equals("com.example.plugins.model.impl.FooImpl")) {
    ...
    public static Throwable translateThrowable(Throwable throwable) {
        ...
        if (className.equals("com.example.plugins.NoSuchFooException")) {
            return new com.example.plugins.NoSuchFooException();
        }
