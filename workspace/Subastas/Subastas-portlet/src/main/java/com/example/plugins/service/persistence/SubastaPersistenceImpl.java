...
public class SubastaPersistenceImpl extends BasePersistenceImpl<Subasta>
    ...
    public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID = new FinderPath(SubastaModelImpl.ENTITY_CACHE_ENABLED,
            ...
            SubastaModelImpl.NOMBREPRODUCTO_COLUMN_BITMASK);
    ...
    public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_FECHAFIN = new FinderPath(SubastaModelImpl.ENTITY_CACHE_ENABLED,
            SubastaModelImpl.FINDER_CACHE_ENABLED, SubastaImpl.class,
            FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByfechaFin",
            new String[] {
                Date.class.getName(),
    ...
    public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_FECHAFIN =
        new FinderPath(SubastaModelImpl.ENTITY_CACHE_ENABLED,
            SubastaModelImpl.FINDER_CACHE_ENABLED, Long.class,
            FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByfechaFin",
            new String[] { Date.class.getName() });
    private static final String _FINDER_COLUMN_FECHAFIN_FECHAFIN_1 = "subasta.fechaFin >= NULL";
    private static final String _FINDER_COLUMN_FECHAFIN_FECHAFIN_2 = "subasta.fechaFin >= ?";
    ...
    /**
     * Returns all the subastas where fechaFin &ge; &#63;.
     *
     ...
     */
    @Override
    public List<Subasta> findByfechaFin(Date fechaFin)
        throws SystemException {
        return findByfechaFin(fechaFin, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
            null);
    }

    /**
     * Returns a range of all the subastas where fechaFin &ge; &#63;.
     *
     * <p>
     * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.example.plugins.model.impl.SubastaModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
     * </p>
     ...
     */
    @Override
    public List<Subasta> findByfechaFin(Date fechaFin, int start, int end)
        throws SystemException {
        return findByfechaFin(fechaFin, start, end, null);
    }

    /**
     * Returns an ordered range of all the subastas where fechaFin &ge; &#63;.
     *
     * <p>
     * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.example.plugins.model.impl.SubastaModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
     * </p>
    ...
    public List<Subasta> findByfechaFin(Date fechaFin, int start, int end,
        ...
        finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_FECHAFIN;
        finderArgs = new Object[] { fechaFin, start, end, orderByComparator };
        ...
        if ((list != null) && !list.isEmpty()) {
            for (Subasta subasta : list) {
                if ((fechaFin.getTime() > subasta.getFechaFin().getTime())) {
                    list = null;
        ...
        if (list == null) {
            ...
            if (fechaFin == null) {
                query.append(_FINDER_COLUMN_FECHAFIN_FECHAFIN_1);
            } else {
                bindFechaFin = true;

                query.append(_FINDER_COLUMN_FECHAFIN_FECHAFIN_2);
            }
    ...
    /**
     * Returns the first subasta in the ordered set where fechaFin &ge; &#63;.
     *
     * @param fechaFin the fecha fin
     * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
     * @return the first matching subasta
     ...
     */
    @Override
    public Subasta findByfechaFin_First(Date fechaFin,
        OrderByComparator orderByComparator)
        throws NoSuchSubastaException, SystemException {
        Subasta subasta = fetchByfechaFin_First(fechaFin, orderByComparator);
     ...
     */
    @Override
    public Subasta fetchByfechaFin_First(Date fechaFin,
        OrderByComparator orderByComparator) throws SystemException {
        List<Subasta> list = findByfechaFin(fechaFin, 0, 1, orderByComparator);
    ...
    /**
     * Returns the last subasta in the ordered set where fechaFin &ge; &#63;.
     *
     * @param fechaFin the fecha fin
     * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
     * @return the last matching subasta
     ...
     */
    @Override
    public Subasta findByfechaFin_Last(Date fechaFin,
        OrderByComparator orderByComparator)
        throws NoSuchSubastaException, SystemException {
        Subasta subasta = fetchByfechaFin_Last(fechaFin, orderByComparator);
     ...
     */
    @Override
    public Subasta fetchByfechaFin_Last(Date fechaFin,
        OrderByComparator orderByComparator) throws SystemException {
        int count = countByfechaFin(fechaFin);

        if (count == 0) {
            return null;
        }

        List<Subasta> list = findByfechaFin(fechaFin, count - 1, count,
                orderByComparator);
    ...
    /**
     * Returns the subastas before and after the current subasta in the ordered set where fechaFin &ge; &#63;.
     *
     * @param subastaId the primary key of the current subasta
     * @param fechaFin the fecha fin
     * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
     ...
     */
    @Override
    public Subasta[] findByfechaFin_PrevAndNext(long subastaId, Date fechaFin,
        OrderByComparator orderByComparator)
        throws NoSuchSubastaException, SystemException {
        Subasta subasta = findByPrimaryKey(subastaId);
        ...
        try {
            ...
            array[0] = getByfechaFin_PrevAndNext(session, subasta, fechaFin,
                    orderByComparator, true);

            array[1] = subasta;

            array[2] = getByfechaFin_PrevAndNext(session, subasta, fechaFin,
                    orderByComparator, false);
    ...
    protected Subasta getByfechaFin_PrevAndNext(Session session,
        Subasta subasta, Date fechaFin, OrderByComparator orderByComparator,
        boolean previous) {
        StringBundler query = null;
    ...
    /**
     * Removes all the subastas where fechaFin &ge; &#63; from the database.
     *
     * @param fechaFin the fecha fin
     * @throws SystemException if a system exception occurred
     */
    @Override
    public void removeByfechaFin(Date fechaFin) throws SystemException {
        for (Subasta subasta : findByfechaFin(fechaFin, QueryUtil.ALL_POS,
                QueryUtil.ALL_POS, null)) {
            remove(subasta);
        }
    }
    ...
    /**
     * Returns the number of subastas where fechaFin &ge; &#63;.
     *
     * @param fechaFin the fecha fin
     * @return the number of matching subastas
     * @throws SystemException if a system exception occurred
     */
    @Override
    public int countByfechaFin(Date fechaFin) throws SystemException {
        FinderPath finderPath = FINDER_PATH_WITH_PAGINATION_COUNT_BY_FECHAFIN;

        Object[] finderArgs = new Object[] { fechaFin };
    ...
    protected Subasta toUnwrappedModel(Subasta subasta) {
        ...
        subastaImpl.setNombreProducto(subasta.getNombreProducto());
        subastaImpl.setDescripcion(subasta.getDescripcion());
