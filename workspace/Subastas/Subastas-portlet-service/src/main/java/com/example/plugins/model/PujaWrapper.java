...
public class PujaWrapper implements Puja, ModelWrapper<Puja> {
    ...
    */
    ...
    /**
    * Returns the valor puja of this puja.
    *
    * @return the valor puja of this puja
    */
    @Override
    public double getValorPuja() {
        return _puja.getValorPuja();
    }

    /**
    * Sets the valor puja of this puja.
    *
    * @param valorPuja the valor puja of this puja
    */
    @Override
    public void setValorPuja(double valorPuja) {
        _puja.setValorPuja(valorPuja);
    }

    /**
    * Returns the id subasta of this puja.
    *
    * @return the id subasta of this puja
    */
    @Override
    public long getIdSubasta() {
        return _puja.getIdSubasta();
    }

    /**
    * Sets the id subasta of this puja.
    *
    * @param idSubasta the id subasta of this puja
    */
    @Override
    public void setIdSubasta(long idSubasta) {
        _puja.setIdSubasta(idSubasta);
    }
