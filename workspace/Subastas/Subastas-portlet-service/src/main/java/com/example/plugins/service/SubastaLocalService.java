...
/**
 * Provides the local service interface for Subasta. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SubastaLocalServiceUtil
...
public interface SubastaLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link SubastaLocalServiceUtil} to access the subasta local service. Add custom service methods to {@link com.example.plugins.service.impl.SubastaLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
