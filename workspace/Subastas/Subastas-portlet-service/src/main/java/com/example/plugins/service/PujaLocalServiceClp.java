 ...
 * @generated
 */
public class PujaLocalServiceClp implements PujaLocalService {
    ...
    public PujaLocalServiceClp(InvokableLocalService invokableLocalService) {
        ...
        _methodParameterTypes23 = new String[] { "com.example.plugins.model.Puja" };
    }
    ...
    public com.example.plugins.model.Puja addPuja(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(puja) });
        } catch (Throwable t) {
        ...
        return (com.example.plugins.model.Puja) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.example.plugins.model.Puja createPuja(long pujaId) {
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { pujaId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.example.plugins.model.Puja deletePuja(long pujaId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { pujaId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.example.plugins.model.Puja fetchPuja(long pujaId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { pujaId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.example.plugins.model.Puja getPuja(long pujaId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName13,
                    _methodParameterTypes13, new Object[] { pujaId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.example.plugins.model.Puja> getPujas(int start,
        ...
        return (java.util.List<com.example.plugins.model.Puja>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    @Override
    public void pujar(com.example.plugins.model.Puja puja)
        throws com.example.plugins.NoSuchPujaException,
            com.example.plugins.NoSuchSubastaException,
            com.liferay.portal.kernel.exception.SystemException {
        try {
            ...
            if (t instanceof com.example.plugins.NoSuchPujaException) {
                throw (com.example.plugins.NoSuchPujaException) t;
            }

            if (t instanceof com.example.plugins.NoSuchSubastaException) {
                throw (com.example.plugins.NoSuchSubastaException) t;
            }
